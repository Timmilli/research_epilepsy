...
Used in article in \ref{sub:sec:res1}

\subsection{MELD Project}

The database is accessible on demand here: \href{https://meldproject.github.io//}{website}

The GitHub is here in \citeref{sub:sec:meld_github}

The research is here in \citeref{sub:sec:res2}
...
Article here: \citeref{sub:sec:res7}
...
\begin{table}[htbp]
	...
	\caption{Repartition in the benchmark of FastMRI (\citeref{sub:sec:FastMRI})}
	\label{tab:FastMRI}
\end{table}
...
\begin{table}[htbp]
	...
	\caption{Repartition in the benchmark of Br35H (\citeref{sub:sec:br35h})}
	\label{tab:br35h}
\end{table}
...
\begin{table}[htbp]
	...
	\caption{Repartition in the benchmark of AOMIC (\citeref{sub:sec:aomic})}
	\label{tab:aomic}
\end{table}
